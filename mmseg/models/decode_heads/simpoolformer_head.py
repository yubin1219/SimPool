...
class SimPoolFormerHead(BaseDecodeHead):
    def __init__(self, feature_strides, additional_pool_ratio, **kwargs):
        super(SimPoolFormerHead, self).__init__(input_transform='multiple_select', **kwargs)
        ...
        self.attn4 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio)
        self.attn44 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio)
        self.attn444 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio)

        self.attn3 = Block(dim1=c3_in_channels, num_heads=4, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio*2)
        self.attn33 = Block(dim1=c3_in_channels, num_heads=4, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio*2)

        self.attn2 = Block(dim1=c2_in_channels, num_heads=2, mlp_ratio=mlp_ratio, drop_path=0.1, pool_ratio=additional_pool_ratio*4)
