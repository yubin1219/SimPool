...
class CrossAttention(nn.Module):
    def __init__(self, dim1, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., pool_ratio=16):
        ...
        self.kv = nn.Linear(dim1, dim1 * 2, bias=qkv_bias)
...
class Block(nn.Module):
    ...
    def __init__(self, dim1, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.attn = CrossAttention(dim1=dim1, num_heads=num_heads, pool_ratio=pool_ratio)
...
class ProposedHead(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, **kwargs):
        super(ProposedHead, self).__init__(input_transform='multiple_select', **kwargs)
        ...
        self.attn4 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=4, drop_path=0.1, pool_ratio=1)
        # self.attn44 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=4, drop_path=0.1, pool_ratio=1)
        self.attn3 = Block(dim1=c3_in_channels, num_heads=5, mlp_ratio=4, drop_path=0.1, pool_ratio=2)
        # self.attn33 = Block(dim1=c3_in_channels, num_heads=5, mlp_ratio=4, drop_path=0.1, pool_ratio=2)
        self.attn2 = Block(dim1=c2_in_channels, num_heads=2, mlp_ratio=4, drop_path=0.1, pool_ratio=4)
        # self.attn22 = Block(dim1=c2_in_channels, num_heads=2, mlp_ratio=4, drop_path=0.1, pool_ratio=4)
        # self.attn1 = Block(dim1=c1_in_channels, num_heads=2, mlp_ratio=4, drop_path=0.1, pool_ratio=8)
